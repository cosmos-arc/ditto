...
class TestDatasetStatusResponse:
    ...
    def test_full_model(self) -> None:
        """完整字段创建."""
        from ditto_interfaces.models.ingestion import DatasetStatusResponse
...
class TestIngestionStatusResponse:
    ...
    def test_empty_datasets(self) -> None:
        """空数据集列表."""
        from ditto_interfaces.models.ingestion import IngestionStatusResponse
...
class TestIngestionHistoryItem:
    ...
    def test_success_item(self) -> None:
        """成功摄取记录."""
        from ditto_interfaces.models.ingestion import IngestionHistoryItem
...
class TestDQDatasetSummary:
    ...
    def test_full_model(self) -> None:
        """完整字段."""
        from ditto_interfaces.models.ingestion import DQDatasetSummary
...
class TestDQSummaryResponse:
    ...
    def test_empty_datasets(self) -> None:
        """空列表（V1 占位）."""
        from ditto_interfaces.models.ingestion import DQSummaryResponse
