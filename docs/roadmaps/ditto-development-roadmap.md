...
> **2026-08-25 执行裁决**：当前跨仓库产品范围、优先级和验收以
> [统一产品路线图](../plans/2026-08-25-integrated-product-roadmap.md) 为准。本文保留
> R0—R7 长期能力顺序；其中认证/RBAC、多租户、复杂隔离、机构化和全球化均已冻结，
> 不得进入当前 P0—P5 backlog，除非出现新的真实用户场景并再次获得明确批准。

## 1. 路线图职责

本文维护长期能力方向和 Release 依赖。当前“做什么、按什么顺序、如何跨仓库验收”
由 2026-08-25 统一产品路线图决定；本文不替代能力事实和 release 施工图。
...
- 最大产品缺口：前端视觉/交互与 live 工作流没有把 R1—R5 能力完整交付；分钟/盘中
  与全球资产仍是后续能力空白。
...
- 执行统一产品路线图 P0—P2：事实收口、R5 合并、统一 Shell 和日常决策/交易闭环。
