...
#### 任务1: 实现RegimeEngine
- **文件**：
  - `packages/core/src/ditto_core/engine/regime_engine.py`
  - `packages/core/src/ditto_core/engine/extreme_market_detector.py`
...
#### 任务2: 实现因子系统
- **文件**：
  - `packages/core/src/ditto_core/factors/base.py` - Factor基类
  - `packages/core/src/ditto_core/factors/rs_factor.py`
  - `packages/core/src/ditto_core/factors/volatility_factor.py`
  - `packages/core/src/ditto_core/factors/value_factor.py`
...
#### 任务3: 实现策略框架
- **文件**：
  - `packages/core/src/ditto_core/strategy/base.py`
  - `packages/core/src/ditto_core/strategy/rotation_strategy.py`
...
#### 任务5: 技术指标库
- **文件**：
  - `packages/core/src/ditto_core/indicators/technical.py`
- **功能**：
  - Polars原生实现
  - 比Pandas-TA快18倍
