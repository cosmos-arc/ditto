...
- 提交 `247690d7` 复试仍被同一外部条件拒绝：[run 34088593605](https://github.com/cosmos-arc/ditto/actions/runs/34088593605) 的 Repository policy 与 CI gate annotation 均为 GitHub billing/spending limit，其余真实平台、安全与发布 job 全部 skipped。
