# Visual Audit: factor-list

- Result: **PASS**
- Pixel diff: **4.33%**
- Route: `/research/factors`
- React URL: http://127.0.0.1:5173/research/factors
- Prototype URL: http://127.0.0.1:8888/docs/designs/specs/prototypes/page-factor-list.html
- Viewport: 1536x900
- Captured: 2026-08-30T06:15:14.469Z
...
| toolbar | 56, 68, 1480x32 | 56, 68, 1480x32 | 0 | 0 | 0 | 0 |
| main | 56, 137, 1159x763 | 56, 137, 1160x763 | 0 | 0 | 1 | 0 |
| detail | 1216, 100, 320x800 | 1216, 100, 320x800 | 0 | 0 | 0 | 0 |
...
| toolbar | `background` | oklch(0.176 0.004 253) none repeat scroll 0% 0% / auto padding-box border-box | oklch(0.184 0.011 253) none repeat scroll 0% 0% / auto padding-box border-box |
| toolbar | `backgroundColor` | oklch(0.176 0.004 253) | oklch(0.184 0.011 253) |
...
| detail | `transform` | none | matrix(1, 0, 0, 1, 0, -37) |
| detail | `zIndex` | auto | 1 |
