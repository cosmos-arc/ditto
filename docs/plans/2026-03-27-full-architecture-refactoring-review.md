...
这与当前仓库中 [input_assembler.py](../../interfaces/src/ditto_interfaces/services/strategy/input_assembler.py) 和 [backtest_service.py](../../interfaces/src/ditto_interfaces/services/strategy/backtest_service.py) 已经呈现出的收敛方向一致。
...
现有 [interfaces/src/ditto_interfaces/services](../../interfaces/src/ditto_interfaces/services) 中已经存在大量 application 形态代码，应优先抽象为：
