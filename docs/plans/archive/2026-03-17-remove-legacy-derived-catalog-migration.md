...
| # | 文件 | 原因 |
|---|------|------|
| 1 | `packages/data/src/ditto_data/stores/runtime/derived_catalog/_json_records.py` | 旧 JSON I/O |
| 2 | `packages/data/src/ditto_data/stores/runtime/derived_catalog/derived_catalog_reader.py` | 旧文件读卡器 |
| 3 | `packages/data/src/ditto_data/stores/runtime/derived_catalog/derived_catalog_writer.py` | 旧文件写卡器 |
| 4 | `packages/data/src/ditto_data/stores/runtime/derived_catalog/__init__.py` | 仅 re-export |
| 5 | `packages/data/src/ditto_data/services/derived_migration_service.py` | 一次性迁移服务 |
| 6 | `packages/data/tests/unit/stores/runtime/derived_catalog/test_derived_catalog_store_unit.py` | 旧读写器测试 |
| 7 | `packages/data/tests/unit/services/test_legacy_derived_catalog_migration_service.py` | 迁移服务测试 |
| 8 | `packages/data/tests/integration/runtime/test_legacy_derived_catalog_migration_query_integration.py` | 迁移集成测试 |
...
| # | 文件 | 改动 |
|---|------|------|
| 1 | `packages/data/src/ditto_data/services/__init__.py` | 移除 `LegacyDerivedCatalogMigration*` 的 import 和 `__all__` |
