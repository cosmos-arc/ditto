...
export const USAGE = `Usage:
  bun scripts/visual-audit/visual-audit.mjs --route <route> --react-base <url> --prototype-base <url>
  bun scripts/visual-audit/visual-audit.mjs --all --react-base <url> --prototype-base <url>
