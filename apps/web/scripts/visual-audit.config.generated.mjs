...
export const VISUAL_AUDIT_PAGES = [
  ...
  },
  {
    ...
    prototype: "experiment-create.contract.json",
    prototypeTargets: {
      'rail': ".shell-rail",
      'header': ".studio-header",
      'main': ".studio-main",
      'actions': ".studio-modes",
      'status': ".status-bar",
    },
    reactTargets: {
      'shell': "#root > div",
      ...
      'header': "header",
      'main': "main",
      'actions': "[data-contract-slot='experiment-actions']",
      'status': "[data-slot='status-bar']",
    },
  },
  {
    ...
    prototype: "experiment-detail.contract.json",
    prototypeTargets: {
      'rail': ".shell-rail",
      'header': ".object-header",
      'meta': ".filter-toolbar",
      'main': ".catalog-table",
      'bottom': ".catalog-detail",
      'status': ".status-bar",
    },
    reactTargets: {
      'shell': "#root > div",
      'rail': "nav[aria-label='主导航']",
      'header': "header",
      'meta': "[data-contract-slot='experiment-meta']",
      'main': "main",
      'bottom': "[data-slot='status-bar']",
      'status': "[data-slot='status-bar']",
    },
  },
  {
  ...
  },
  {
    ...
    name: "review-detail",
    prototype: "review-detail.contract.json",
    prototypeTargets: {
      'rail': ".shell-rail",
      'header': ".object-header",
      'meta': ".shell-strip",
      'main': ".shell-main",
      'bottom': ".shell-analysis",
    },
    reactTargets: {
      'shell': "#root > div",
      'rail': "nav[aria-label='主导航']",
      'header': "header",
      'meta': "[data-contract-slot='review-decision-banner']",
      'main': "[data-contract-slot='review-evidence']",
      'bottom': "[data-contract-slot='review-actions']",
    },
  },
  {
    route: "/research/reviews",
    name: "review-list",
    prototype: "review-list.contract.json",
    prototypeTargets: {
      'rail': ".shell-rail",
      'header': ".shell-header",
