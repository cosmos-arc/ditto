...
1. **最终质量 pass** — 调用 `impeccable:polish`（20 项 polish checklist：alignment、spacing、typography、color、interaction states、micro-interactions、content consistency、icons/images、forms、edge cases、responsiveness、performance、code quality）
2. **代码简化** — 调用 `code-simplifier:code-simplifier`
