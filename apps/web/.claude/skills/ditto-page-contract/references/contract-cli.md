...
```bash
bun -e "
import { validateContract } from './.claude/skills/ditto-page-contract/scripts/validators/contract-validator.mjs';
...
```bash
bun -e "
import { validateAllContracts } from './.claude/skills/ditto-page-contract/scripts/validators/contract-validator.mjs';
...
```bash
bun .claude/skills/ditto-page-contract/scripts/create.mjs --prototype <prototype-path>
