...
- geometry-height-ratio (strip): actual 3.7222222222222223, allowed 0.05
- geometry-x (main): actual 16, allowed 4
- geometry-y (main): actual 16, allowed 4
- geometry-height-ratio (main): actual 0.078502025297582, allowed 0.05
- geometry-y (activity): actual 16, allowed 4
- geometry-width-ratio (activity): actual 0.05333333333333334, allowed 0.03
- geometry-height-ratio (activity): actual 0.078502025297582, allowed 0.05

- Captured: 2026-08-30T06:15:50.853Z
...
| strip | 56, 68, 1480x36 | 56, 68, 1480x170 | 0 | 0 | 0 | 134 |
| main | 72, 254, 1132x402.41 | 56, 238, 1164x434 | -16 | -16 | 32 | 31.59 |
| activity | 1220, 254, 300x402.41 | 1220, 238, 316x434 | 0 | -16 | 16 | 31.59 |
| analysis | 56, 672.41, 1480x203.59 | 56, 672, 1480x204 | 0 | -0.41 | 0 | 0.41 |
...
| strip | `borderColor` | oklch(0.3964 0.01972 202.88) oklch(0.3964 0.01972 202.88) oklch(0.3705 0.0402... | oklch(0.94 0.004 253) |
| strip | `borderLeftColor` | oklch(0.3964 0.01972 202.88) | oklch(0.94 0.004 253) |
