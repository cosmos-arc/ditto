...
- Pixel diff: **5.01%**
- Route: `/research`
- React URL: http://127.0.0.1:5173/research
- Prototype URL: http://127.0.0.1:8888/docs/designs/specs/prototypes/page-research.html
- Viewport: 1200x800
## Blocking Failures

- pixel-diff: actual 0.050091666666666666, allowed 0.05

- Captured: 2026-08-30T06:24:16.173Z
...
| main | 56, 104, 844x516 | 56, 104, 844x516 | 0 | 0 | 0 | 0 |
| activity | 900, 104, 300x696 | 900, 104, 300x696 | 0 | 0 | 0 | 0 |
| analysis | 56, 620, 844x180 | 56, 620, 844x180 | 0 | 0 | 0 | 0 |
| factor-monitor | 72, 120, 812x484 | 68, 116, 820x492 | -4 | -4 | 8 | 8 |
| research-activity | 900, 104, 300x696 | 900, 104, 300x696 | 0 | 0 | 0 | 0 |
...
| header | `zIndex` | 20 | 5 |
| strip | `borderColor` | oklch(0.38856 0.03092 266.16) oklch(0.38856 0.03092 266.16) oklch(0.255 0.006... | oklch(0.94 0.004 253) |
...
| factor-monitor | `boxShadow` | oklch(0.94 0.004 253 / 0.03) 0px 1px 3px 0px | none |
| factor-monitor | `borderColor` | oklch(0.64 0.12 235 / 0.25) oklch(0.255 0.006 253) oklch(0.255 0.006 253) | oklch(0.255 0.006 253) |
| research-activity | `borderColor` | oklch(0.94 0.004 253) oklch(0.94 0.004 253) oklch(0.94 0.004 253) oklch(0.255... | oklch(0.255 0.006 253) |
| research-activity | `borderBottomColor` | oklch(0.94 0.004 253) | oklch(0.255 0.006 253) |
| research-activity | `borderStyle` | none none none solid | solid |
