...
export function PortfolioOverviewSignalsPanel() {
	const usePrototypeMocks = shouldUsePrototypeMocks();

	return (
		<Panel
			data-info-level="l2"
			data-info-unit="signals-queue"
			className="h-full rounded-none border-y-0 border-r-0 bg-(--color-surface-panel-base)"
		>
