 ...
 */
export function OpsConsoleLayout({ health, main, detail, className }: OpsConsoleLayoutProps) {
	...
	return (
		...
		>
			{health && (
				<div className="min-h-0 overflow-hidden [grid-area:health]" data-slot="health">
					{health}
				</div>
			)}
