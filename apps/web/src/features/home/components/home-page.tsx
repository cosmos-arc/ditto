...
export function HomePage() {
	return (
		<CommandCenterLayout
			pulse={<PulseSection />}
			main={
				<div data-slot="home-main" className="flex h-full min-h-0 flex-col gap-[calc(var(--density-gutter)+var(--space-8))] p-[var(--density-gutter)]">
					{/* main-primary: Decision Banner + Priority Queue + Workspace Placeholder */}
					<div data-slot="home-primary" className="flex min-h-0 max-h-[66%] flex-none flex-col gap-(--density-section-gap) overflow-hidden">
						<BannerSection />
					...
					<div data-slot="home-secondary" className="grid min-h-0 flex-1 grid-cols-2 gap-[var(--density-gutter)] overflow-hidden">
