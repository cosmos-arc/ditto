...
export function WorkspacePlaceholder() {
	return (
		<div className="mt-2 flex flex-col items-center justify-center rounded-md border border-dashed border-(--color-border) px-3 py-4 text-center" data-info-level="l2" data-info-unit="workspace-placeholder">
