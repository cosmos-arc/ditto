...
// ── TradingPage: 5 L1, 4 L2 ──

describe("TradingPage info-level annotations", () => {
	beforeEach(() => server.use(...tradingHandlers));
...
describe("RiskPage info-level annotations", () => {
	...
	it("annotates 4 L1 information units", async () => {
		...
		expect(l1UnitNames).toContain("sector-breakdown");
		expect(l1UnitNames).toContain("risk-breaches-list");
