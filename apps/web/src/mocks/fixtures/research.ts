...
export const mockFactors: GetFactorsResponse = {
	items: [
		...
		},
		{
			...
			lastUpdated: "2026-04-07T20:00:00Z",
			sharpe: 0.68,
			universe: "全A",
		},
		{
	...
	items: [
		{
			...
			type: "backtest",
			status: "completed",
			startTime: "2026-04-08T01:00:00Z",
			endTime: "2026-04-08T02:30:00Z",
			keyMetric: "Sharpe 1.82",
		},
		{
			id: "run-002",
			name: "因子 IC 日报",
...
export const mockReviewQueue: GetReviewQueueResponse = {
	items: [
		...
		{ id: "rev-002", type: "strategy", name: "动量突破 v4", status: "pending", submittedAt: "2026-04-08T07:30:00Z" },
		{
			...
			name: "Q2 因子权重优化",
			status: "approved",
			submittedAt: "2026-04-07T16:00:00Z",
		},
	],
	total: 5,
	page: 1,
...
export const mockFactorDetail: FactorDetailResponse = {
	...
	history: [
		...
		{ date: "2026-03-28", ic: 0.048, ir: 0.8 },
		{ date: "2026-03-27", ic: 0.06, ir: 0.9 },
		{ date: "2026-03-26", ic: 0.035, ir: 0.62 },
	] as const,
	diagnostics: [
		{ name: "衰减测试", result: "pass", value: 0.038, threshold: 0.02 },
		{ name: "换手率测试", result: "pass", value: 0.32, threshold: 0.5 },
		{ name: "覆盖率测试", result: "pass", value: 0.92, threshold: 0.8 },
...
export const mockFactorAnalysis: FactorAnalysisResponse = {
	icTimeSeries: [
		...
		{ date: "2026-03-27", ic: 0.06, ir: 0.9 },
		{ date: "2026-03-26", ic: 0.035, ir: 0.62 },
		{ date: "2026-03-25", ic: 0.05, ir: 0.85 },
