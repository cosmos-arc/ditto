...
export const mockTradingSession: PortfolioSessionResponse = {
	phase: "continuous",
	cashBalance: 8_432_180.5,
	margin: {
		totalMargin: 4_200_000,
		usedMargin: 3_218_400,
		availableMargin: 981_600,
		maintenanceRatio: 2.86,
	},
	riskBudget: 0.682,
	routeHealth: {
...
export const mockSignalDetail: GetSignalDetailResponse = {
	...
	execution: {
		...
		reviewReasons: ["VOLATILITY_ABOVE_THRESHOLD", "SECTOR_EXPOSURE_REVIEW"],
		status: "pending",
	},
} as const;
