 ...
 * Schema SHA-256: f45c8ecf2bf4e0ee62e2fe7b8e257f7a3ef9836af736d3f791515e35f3c598d7
...
export const operationResponseContracts = {
  ...
  "post /api/v1/portfolio/etf-allocations/{allocation_id}/versions/{version_id}/paper-executions": {
    "201": ["application/json"],
    "400": ["application/json"],
    "403": ["application/json"],
    "404": ["application/json"],
