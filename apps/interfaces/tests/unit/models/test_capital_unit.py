...
class TestMarginQuery:
    ...
    def test_default_values(self) -> None:
        ...
        from ditto_interfaces.models.capital import MarginQuery
...
class TestMargin:
    ...
    def test_basic_margin(self) -> None:
        """验证基本 Margin 创建."""
        from ditto_interfaces.models.capital import Margin
...
class TestToMargin:
    ...
    def test_convert_complete_row(self) -> None:
        """验证完整行转换."""
        from ditto_interfaces.models.capital import to_margin
...
class TestToMarginList:
    ...
    def test_convert_empty_dataframe(self) -> None:
        """验证空 DataFrame 转换."""
        from ditto_interfaces.models.capital import to_margin_list
...
class TestValuationQuery:
    ...
    def test_required_fields(self) -> None:
        """验证必填字段."""
        from ditto_interfaces.models.capital import ValuationQuery
...
class TestValuation:
    ...
    def test_basic_valuation(self) -> None:
        """验证基本 Valuation 创建."""
        from ditto_interfaces.models.capital import Valuation
...
class TestToValuation:
    ...
    def test_convert_complete_row(self) -> None:
        """验证完整行转换."""
        from ditto_interfaces.models.capital import to_valuation
...
class TestToValuationList:
    ...
    def test_convert_empty_dataframe(self) -> None:
        """验证空 DataFrame 转换."""
        from ditto_interfaces.models.capital import to_valuation_list
