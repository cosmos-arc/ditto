...
class TestFinancialType:
    ...
    def test_financial_type_values(self) -> None:
        ...
        from ditto_interfaces.models.fundamental import FinancialType
...
class TestFinancialQuery:
    ...
    def test_default_values(self) -> None:
        ...
        from ditto_interfaces.models.fundamental import FinancialQuery
...
class TestFinancial:
    ...
    def test_basic_financial(self) -> None:
        """验证基本 Financial 创建."""
        from ditto_interfaces.models.fundamental import Financial
...
class TestToFinancial:
    ...
    def test_convert_complete_row(self) -> None:
        """验证完整行转换."""
        from ditto_interfaces.models.fundamental import FinancialType, to_financial
...
class TestToFinancialList:
    ...
    def test_convert_empty_dataframe(self) -> None:
        """验证空 DataFrame 转换."""
        from ditto_interfaces.models.fundamental import FinancialType, to_financial_list
...
class TestDividendQuery:
    ...
    def test_required_fields(self) -> None:
        """验证必须字段: instrument_id, as_of_date."""
        from ditto_interfaces.models.fundamental import DividendQuery
...
class TestDividend:
    ...
    def test_basic_dividend(self) -> None:
        """验证基本 Dividend 创建."""
        from ditto_interfaces.models.fundamental import Dividend
...
class TestToDividend:
    ...
    def test_convert_complete_row(self) -> None:
        """验证完整行转换."""
        from ditto_interfaces.models.fundamental import to_dividend
...
class TestToDividendList:
    ...
    def test_convert_empty_dataframe(self) -> None:
        """验证空 DataFrame 转换."""
        from ditto_interfaces.models.fundamental import to_dividend_list
...
class TestCorporateActionsQuery:
    ...
    def test_required_fields(self) -> None:
        ...
        from ditto_interfaces.models.fundamental import CorporateActionsQuery
...
class TestCorporateAction:
    ...
    def test_basic_corporate_action(self) -> None:
        ...
        from ditto_interfaces.models.fundamental import CorporateAction
...
class TestToCorporateAction:
    ...
    def test_convert_complete_row(self) -> None:
        """验证完整行转换."""
        from ditto_interfaces.models.fundamental import to_corporate_action
...
class TestToCorporateActionList:
    ...
    def test_convert_empty_dataframe(self) -> None:
        """验证空 DataFrame 转换."""
        from ditto_interfaces.models.fundamental import to_corporate_action_list
