...
class TestAPIError:
    ...
    def test_default_values(self) -> None:
        ...
        from ditto_port.api.errors import APIError
...
class TestDateRangeError:
    ...
    def test_inherits_from_api_error(self) -> None:
        """验证继承自 APIError."""
        from ditto_port.api.errors import APIError, DateRangeError
...
class TestRateLimitError:
    ...
    def test_error_properties(self) -> None:
        ...
        from ditto_port.api.errors import RateLimitError
    ...
    def test_inherits_from_api_error(self) -> None:
        """验证继承自 APIError."""
        from ditto_port.api.errors import APIError, RateLimitError
