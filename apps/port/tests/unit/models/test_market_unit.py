...
class TestAdjustment:
    ...
    def test_adjustment_values(self) -> None:
        ...
        from ditto_port.models.market import Adjustment
...
class TestBarsQuery:
    ...
    def test_default_values(self) -> None:
        ...
        from ditto_port.models.market import Adjustment, BarsQuery
    ...
    def test_date_range_validation_success(self) -> None:
        ...
        from ditto_port.models.market import BarsQuery
...
class TestBar:
    ...
    def test_basic_bar(self) -> None:
        """验证基本 Bar 创建."""
        from ditto_port.models.market import Bar
...
class TestToBar:
    ...
    def test_convert_complete_row(self) -> None:
        """验证完整行转换."""
        from ditto_port.models.market import to_bar
...
class TestToBarList:
    ...
    def test_convert_empty_dataframe(self) -> None:
        """验证空 DataFrame 转换."""
        from ditto_port.models.market import to_bar_list
