...
class TestMacroCategory:
    ...
    def test_category_values(self) -> None:
        ...
        from ditto_port.models.macro import MacroCategory
...
class TestMacroFrequency:
    ...
    def test_frequency_values(self) -> None:
        ...
        from ditto_port.models.macro import MacroFrequency
...
class TestIndicatorQuery:
    ...
    def test_default_values(self) -> None:
        ...
        from ditto_port.models.macro import IndicatorQuery
...
class TestIndicator:
    ...
    def test_basic_indicator(self) -> None:
        """验证基本 Indicator 创建."""
        from ditto_port.models.macro import Indicator, MacroCategory, MacroFrequency
...
class TestToIndicator:
    ...
    def test_convert_complete_row(self) -> None:
        """验证完整行转换."""
        from ditto_port.models.macro import MacroCategory, MacroFrequency, to_indicator
    ...
    def test_convert_with_missing_optional_fields(self) -> None:
        """验证可选字段缺失时的转换."""
        from ditto_port.models.macro import to_indicator
...
class TestToIndicatorList:
    ...
    def test_convert_multiple_rows_dataframe(self) -> None:
        """验证多行 DataFrame 转换."""
        from ditto_port.models.macro import MacroCategory, to_indicator_list
