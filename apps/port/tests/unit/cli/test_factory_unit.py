...
@pytest.mark.unit
def test_create_daily_command_validates_date(app_ctx):
...
@pytest.mark.unit
def test_create_daily_command_calls_ingest_daily(app_ctx):
...
@pytest.mark.unit
def test_create_daily_command_with_force_flag(app_ctx):
...
@pytest.mark.unit
def test_create_backfill_command_validates_dates(app_ctx):
...
@pytest.mark.unit
def test_create_backfill_command_calls_backfill_range(app_ctx):
...
@pytest.mark.unit
def test_create_basic_command_calls_ingest_daily_with_empty_date(app_ctx):
...
@pytest.mark.unit
def test_create_basic_command_with_force_flag(app_ctx):
