...
class TestETFCommands:
    ...
    def test_etf_daily_delegates_to_factory(self, mocker: MockerFixture, mock_ctx):
    ...
    def test_etf_backfill_delegates_to_factory(self, mocker: MockerFixture, mock_ctx):
    ...
    def test_etf_basic_delegates_to_factory(self, mocker: MockerFixture, mock_ctx):
