...
- 本测试: 使用真实的 ditto_port.main.app，验证路由装配正确性
...
import pytest
from ditto_port.api.routes import __all__ as expected_route_modules
...
class TestMainRoutesAssembly:
    ...
    def test_all_route_modules_have_routers(self) -> None:
        ...
        from ditto_port.api import routes
