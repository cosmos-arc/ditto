...
class TestDailyIngestionFlow:
    ...
    def test_flow_uses_submit_for_t0_tasks(self):
    ...
    def test_t1_tasks_use_wait_for(self):
        ...
        with patch("ditto_datahub.DataHub", return_value=mock_hub):
            with patch("ditto_server.ingestion.flows.daily.create_ingest_task_t0"):
                with patch(
    ...
    def test_flow_returns_dqc_placeholder(self):
...
class TestTradingDayValidation:
    ...
    def test_check_trading_day_closes_hub(self):
    ...
    def test_valid_trade_date_executes_tasks(self):
...
class TestTaskDependencyOrchestration:
    ...
    def test_t0_tasks_submitted_in_parallel(self):
        ...
        with patch("ditto_datahub.DataHub", return_value=mock_hub):
            with patch(
                ...
                with patch(
                    ...
                    # Setup T1 mocks
                    mock_t1_task = MagicMock()
                    mock_t1_task.submit.return_value = MagicMock(
                        result=MagicMock(
                            return_value={
                                "dataset": "stock_daily",
                                "status": "success",
...
class TestResultAggregation:
    ...
    def test_aggregate_with_success_results(self):
    ...
    def test_aggregate_includes_all_sections(self):
...
class TestErrorHandling:
    ...
    def test_flow_handles_missing_dataset_key(self):
