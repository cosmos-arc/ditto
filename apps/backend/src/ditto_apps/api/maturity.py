...
ROUTE_MATURITY_BY_PREFIX: dict[str, ApiMaturity] = {
    ...
    "/api/v1/research": "experimental",
    "/api/v1/selections": "initial-focus",
    "/api/v1/technical-analysis": "initial-focus",
    "/api/v1/manual": "initial-focus",
    "/api/v1/paper": "initial-focus",
    "/api/v1/portfolio": "initial-focus",
...
_TAG_MATURITY: tuple[tuple[str, ApiMaturity], ...] = (
    ...
    ("selections", "initial-focus"),
    ("technical-analysis", "initial-focus"),
    ("manual", "initial-focus"),
    ("paper", "initial-focus"),
    ("portfolio", "initial-focus"),
