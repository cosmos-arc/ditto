...
class TestStrategyVersion:
    def test_create_version(self) -> None:
        from ditto_engine.alpha.models import StrategyVersion
...
class TestStrategyTemplate:
    def test_create_template(self) -> None:
        from ditto_engine.alpha.models import StrategyTemplate
...
class TestStrategyRun:
    def test_create_run(self) -> None:
        from ditto_engine.alpha.models import StrategyRun
...
class TestSignalSnapshot:
    def test_create_signal_snapshot(self) -> None:
        from ditto_engine.alpha.models import SignalSnapshot
...
class TestRebalancePlan:
    def test_create_rebalance_plan(self) -> None:
        from ditto_engine.alpha.models import RebalancePlan
