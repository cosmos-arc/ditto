...
from ditto_engine.engine.evaluation.report import LongShortResult, TailRiskMetrics
...
def long_short_returns(
    ...
    *,
    ...
    Returns:
        A :class:`~ditto_engine.engine.evaluation.report.LongShortResult`.
    ...
    std_daily = scalar_to_float(ls_daily.std(ddof=1) if n > 1 else None)
