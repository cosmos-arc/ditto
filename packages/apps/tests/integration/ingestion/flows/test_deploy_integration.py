...
def ensure_flow_module_fresh() -> None:
    ...
    try:
        ...
        importlib.reload(ditto_apps.jobs.flows)
    except Exception:
        pass  # 如果重新加载失败，忽略
...
class TestDeployFunctions:
    ...
    def test_list_flows(self):
        ...
        from ditto_apps.jobs.flows.deploy import _get_flow_configs, list_flows
    ...
    def test_deploy_all_flows_exists(self):
        ...
        from ditto_apps.jobs.flows.deploy import deploy_all_flows
    ...
    def test_deploy_creates_deployments(self, mocker):
        ...
        mock_deploy = mocker.patch("ditto_apps.jobs.flows.deploy.deploy")
        deploy_all_flows(
    ...
    def test_get_flow_configs(self):
        ...
        from ditto_apps.jobs.flows.deploy import _get_flow_configs, _resolve_flow
    ...
    def test_get_flow(self):
        ...
        from ditto_apps.jobs.flows.deploy import _get_flow
...
class TestMainFunction:
    ...
    def test_main_list_command(self, mocker):
        ...
        from ditto_apps.jobs.flows.deploy import main as deploy_main

        # Mock sys.argv 和 list_flows
        mocker.patch("sys.argv", ["deploy.py", "list"])
        mock_list = mocker.patch("ditto_apps.jobs.flows.deploy.list_flows")
    ...
    def test_main_default_deploys(self, mocker):
        ...
        mock_deploy = mocker.patch("ditto_apps.jobs.flows.deploy.deploy_all_flows")
