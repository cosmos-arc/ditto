"""Task 17 stock-primary deterministic golden wrapper."""
...
def test_stock_primary_lane_closes_evidence_and_blocks_live_promotion(
    tmp_path: Path,
) -> None:
    """Exercise the real stock pipeline through immutable review evidence."""
    _run_golden(tmp_path, golden_support.STOCK_GOLDEN_LANE, False)
