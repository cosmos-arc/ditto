...
class TestResetForTesting:
    ...
    @patch("ditto_foundation.observability.testing.tracing.reset_tracing")
    @patch("ditto_foundation.observability.testing.metrics.reset_metrics")
...
class TestGetRecordedSpans:
    ...
    @patch("ditto_foundation.observability.testing.tracing.get_in_memory_exporter")
...
class TestGetRecordedMetrics:
    ...
    @patch("ditto_foundation.observability.testing.metrics.get_in_memory_reader")
