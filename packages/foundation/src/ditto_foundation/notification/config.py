...
class NotificationSettings(BaseSettings):
    ...
    Loads from environment variables with NOTIFICATION_ prefix.
    """
    ...
    wechat_corp_id: str | None = Field(
        default=None,
        description="WeChat corp ID",
    )
    wechat_agent_id: str | None = Field(
        default=None,
        description="WeChat agent ID",
    )
