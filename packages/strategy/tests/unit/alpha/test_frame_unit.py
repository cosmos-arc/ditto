...
class TestValidateFramePerStage:
    ...
    def test_universe_stage_output(self) -> None:
        ...
        from ditto_strategy.alpha.builtins import UniverseStage
    ...
    def test_signal_stage_output(self) -> None:
        ...
        from ditto_strategy.alpha.builtins import SignalStage
    ...
    def test_scoring_stage_output(self) -> None:
        ...
        from ditto_strategy.alpha.builtins import ScoringStage
    ...
    def test_selection_stage_output(self) -> None:
        ...
        from ditto_strategy.alpha.builtins import SelectionStage
