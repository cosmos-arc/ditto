...
class TestInitFunction:
    ...
    @patch("ditto_platform.foundation.observability._lifecycle.configure_metrics")
    @patch("ditto_platform.foundation.observability._lifecycle.logger")
...
class TestShutdownFunction:
    ...
    @patch(
        "ditto_platform.foundation.observability._lifecycle.otel_metrics.get_meter_provider"
    )
    @patch("ditto_platform.foundation.observability._lifecycle.logger")
