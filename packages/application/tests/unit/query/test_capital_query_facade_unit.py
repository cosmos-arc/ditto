"""Tests for CapitalQueryFacade — 封装 CapitalStore."""
...
class TestCapitalQueryFacadeGetMarginTrading:
    """CapitalQueryFacade.get_margin_trading — 委托到 CapitalStore."""
    ...
    def test_delegates_to_service(self) -> None:
        ...
        facade = CapitalQueryFacade(capital_store=service)
...
class TestCapitalQueryFacadeGetValuationMetrics:
    """CapitalQueryFacade.get_valuation_metrics — 委托到 CapitalStore."""
