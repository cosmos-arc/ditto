"""
Ports 对象定义 - Service 依赖注入参数分组。

将 Service 的 Reader/Writer 依赖分组为结构化的 Ports 对象，
...
from ditto_datahub.stores.capital.pledge.pledge_ratio_reader import PledgeRatioReader
from ditto_datahub.stores.capital.pledge.pledge_ratio_writer import PledgeRatioWriter
...
from ditto_datahub.stores.fundamental.corporate.dividend_reader import DividendReader
from ditto_datahub.stores.fundamental.corporate.dividend_writer import DividendWriter
...
from ditto_datahub.stores.fundamental.financial.cash_flow_reader import CashFlowReader
from ditto_datahub.stores.fundamental.financial.cash_flow_writer import CashFlowWriter
...
from ditto_datahub.stores.fundamental.forecast.express_reader import ExpressReader
from ditto_datahub.stores.fundamental.forecast.express_writer import ExpressWriter
from ditto_datahub.stores.fundamental.forecast.forecast_reader import ForecastReader
from ditto_datahub.stores.fundamental.forecast.forecast_writer import ForecastWriter
...
from ditto_datahub.stores.market.etf.nav import EtfNavReader, EtfNavWriter
