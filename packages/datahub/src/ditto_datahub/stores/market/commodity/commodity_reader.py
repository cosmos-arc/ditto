...
class CommodityBarsReader:
    ...
    Provides read-only access to commodity daily bars data with year partitioning.
    ...
    Attributes:
        DATASET: Dataset name for commodity bars.
    ...
    def __init__(self, data_root: Path) -> None:
        """
        Initialize CommodityBarsReader.
