...
class CommodityBarsWriter:
    ...
    Provides write access to commodity daily bars data with year partitioning.
    ...
    def __init__(self, data_root: Path) -> None:
        """
        Initialize CommodityBarsWriter.
