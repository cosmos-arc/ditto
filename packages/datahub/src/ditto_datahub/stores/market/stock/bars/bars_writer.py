...
Provides write access to stock daily bars data stored in Parquet files
...
class StockBarsWriter:
    """
    Stock daily bars data writer.

    Provides write access to stock daily bars data with year partitioning.
    ...
    Attributes:
        DATASET: Dataset name for stock bars.
    ...
    def write(
        ...
        """
        return self._store.write(self.DATASET, df, on_duplicate.value, year=year)
