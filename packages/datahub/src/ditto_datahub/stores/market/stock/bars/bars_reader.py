...
Provides read-only access to stock daily bars data stored in Parquet files
...
class StockBarsReader:
    """
    Stock daily bars data reader.

    Provides read-only access to stock daily bars data with year partitioning.
