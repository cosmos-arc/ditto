...
Provides read-only access to stock adjustment factors for dividend/split/bonus events
stored in Parquet files with year partitioning. Following design document at
docs/design/02_data_design.md.
"""


class StockAdjFactorReader:
    """
    Stock adjustment factor data reader.

    Provides read-only access to stock adjustment factors with year partitioning.
    ...
    def __init__(self, data_root: Path) -> None:
        """
        Initialize StockAdjFactorReader.
