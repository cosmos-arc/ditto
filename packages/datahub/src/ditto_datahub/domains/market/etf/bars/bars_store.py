...
class EtfBarsStore(ParquetStoreBase):
    """
    ...
    def get_years(self) -> list[int]:
        """
        Get available years for ETF daily bars data.
    ...
    def get_date_range(self) -> tuple[str | None, str | None]:
        """
        Get overall date range for ETF daily bars data.
    ...
    def list_sids(self) -> list[int]:
        """
        List unique security IDs in ETF daily bars data.
