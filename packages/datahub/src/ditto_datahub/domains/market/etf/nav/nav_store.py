...
class EtfNavStore(ParquetStoreBase):
    ...
    dataset name "market/etf/nav". The read() method does not require a
    dataset parameter.
    """
    ...
    def write(
        ...
        """
        Write ETF net asset value data.
    ...
    def get_years(self) -> list[int]:
        """
        Get available years for ETF NAV data.
    ...
    def get_date_range(self) -> tuple[str | None, str | None]:
        """
        Get overall date range for ETF NAV data.
    ...
    def list_sids(self) -> list[int]:
        """
        List unique security IDs in ETF NAV data.
