...
**位置**: `packages/datahub/src/ditto_datahub/models/storage.py`
...
**位置**: `packages/datahub/src/ditto_datahub/models/__init__.py`
...
**位置**: `packages/datahub/src/ditto_datahub/types.py`
...
✅ **类型检查 (pyright)**
```bash
pixi run -e dev type --path packages/datahub/src/ditto_datahub/models/storage.py
# 结果: 0 errors, 0 warnings, 0 informations
```

✅ **代码检查 (ruff)**
```bash
pixi run -e dev lint packages/datahub/src/ditto_datahub/models/storage.py \
...
from ditto_datahub.types import WriteResult, WriteResultStore, FreezeManifest
```

✅ **推荐的新导入方式**:
```python
# 推荐使用新的导入路径
from ditto_datahub.models.storage import WriteResult, WriteResultStore, FreezeManifest
# 或
from ditto_datahub.models import WriteResult, WriteResultStore, FreezeManifest
```
