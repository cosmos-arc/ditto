...
class TestTelegramAlertSender:
    ...
    def test_send_returns_false_on_http_error(self, mocker: MockerFixture) -> None:
    ...
    def test_send_returns_false_on_raise_for_status(
    ...
    def test_send_uses_correct_url(self, mocker: MockerFixture) -> None:
    ...
    def test_send_sets_parse_mode_to_markdown(self, mocker: MockerFixture) -> None:
    ...
    def test_send_includes_timeout(self, mocker: MockerFixture) -> None:
