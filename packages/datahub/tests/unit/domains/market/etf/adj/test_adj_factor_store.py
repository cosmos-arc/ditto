...
@pytest.fixture
def store(data_root: Path) -> EtfAdjFactorStore:
    """Create EtfAdjFactorStore instance."""
    return EtfAdjFactorStore(data_root)
...
class TestEtfAdjFactorStore:
    ...
    def test_read_no_filters(
        self, store: EtfAdjFactorStore, sample_adj_factor_df: pl.DataFrame
    ) -> None:
    ...
    def test_write_new_file(
        ...
        assert result.file_path == str(
            tmp_path / "data" / "market" / "etf" / "adj" / "2024.parquet"
        )
    ...
    def test_write_creates_directory(
        ...
        dataset_dir = tmp_path / "data" / "market" / "etf" / "adj"
    ...
    def test_get_years_empty(self, store: EtfAdjFactorStore) -> None:
    ...
    def test_get_checksum_missing_file(self, store: EtfAdjFactorStore) -> None:
    ...
    def test_count_empty(self, store: EtfAdjFactorStore) -> None:
    ...
    def test_get_date_range_empty(self, store: EtfAdjFactorStore) -> None:
    ...
    def test_list_sids_empty(self, store: EtfAdjFactorStore) -> None:
