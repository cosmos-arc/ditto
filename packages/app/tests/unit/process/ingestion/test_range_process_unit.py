...
class TestIngestRangeProcess:
    ...
    def test_run_iterates_dates(self) -> None:
        ...
        from ditto_app.process.ingestion.range_process import (
            IngestRangeProcess,
            IngestRangeTrigger,
        )
...
class TestIngestRangeTrigger:
    ...
    def test_creation(self) -> None:
        """基本创建测试."""
        from ditto_app.process.ingestion.range_process import IngestRangeTrigger
...
class TestBackfillRangeTrigger:
    ...
    def test_creation(self) -> None:
        """基本创建测试."""
        from ditto_app.process.ingestion.range_process import BackfillRangeTrigger
