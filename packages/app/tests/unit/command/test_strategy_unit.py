...
class TestStrategyCommandProtocolConformance:
    ...
    def test_create_handler_satisfies_protocol(self) -> None:
        ...
        from ditto_app.command.strategy import CreateStrategyHandler
    ...
    def test_update_handler_satisfies_protocol(self) -> None:
        from ditto_app.command.protocols import CommandHandler
        from ditto_app.command.strategy import UpdateStrategyHandler
    ...
    def test_publish_handler_satisfies_protocol(self) -> None:
        from ditto_app.command.protocols import CommandHandler
        from ditto_app.command.strategy import PublishStrategyHandler
