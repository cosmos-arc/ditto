...
| 文件路径 | 修改内容 |
|---------|---------|
| `packages/features/docs/design/unified-feature-factor-engine/decisions/core/adr-034-publication-lifecycle.md` | 接入 `shadow_ready` / `publish_ready` 认证阶段 |
| `packages/features/docs/design/unified-feature-factor-engine/decisions/quality/adr-036-quality-gates.md` | 明确”最小 DQ”与”认证层”分层 |
| `packages/features/docs/design/unified-feature-factor-engine/decisions/computation/adr-039-expression-cache-persistence.md` | 区分缓存指纹与发布兼容 manifest |
