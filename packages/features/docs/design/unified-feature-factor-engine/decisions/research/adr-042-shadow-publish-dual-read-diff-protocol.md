...
| 文件路径 | 修改内容 |
|---------|---------|
| `packages/features/docs/design/unified-feature-factor-engine/decisions/core/adr-034-publication-lifecycle.md` | 增补 shadow publish 与 promote 前置条件 |
| `packages/features/docs/design/unified-feature-factor-engine/main-design.md` | 增加发布安全与 dual-read diff 段落 |
