"""
Publication safety runtime records for derived certification/shadow/DQ.

Frozen dataclasses shared by data, features, and application packages.
Structural conversion methods (to_json_dict / from_json_dict) are pure
data transformation (dict <-> dataclass), not I/O or persistence.
"""
