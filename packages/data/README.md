...
```python
from ditto_data.sources.schemas import STOCK_DAILY_SOURCE_SCHEMA
import polars as pl
...
from ditto_data.models.macro import MacroQuery
...
**使用示例**：
```python
from ditto_data.services.feature_service import FeatureService
from ditto_data.models.features import FeatureQuery
...
**使用示例**：
```python
from ditto_data.services.factor_service import FactorService
from ditto_data.models.factors import FactorQuery
...
from ditto_data.models.market import AdjType, MarketBarsQuery
...
```python
from ditto_data.services.market_service import MarketService
from ditto_data.models.market import MarketBarsQuery
