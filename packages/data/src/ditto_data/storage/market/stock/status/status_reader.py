...
Provides read-only access to stock status data stored in Parquet files
...
class StockStatusReader:
    """
    Stock status data reader.

    Provides read-only access to stock status data with year partitioning.
