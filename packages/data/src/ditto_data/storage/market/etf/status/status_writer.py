...
Provides write access to ETF status information stored in Parquet files
with year partitioning. Following design document at docs/design/02_data_design.md.
"""


class EtfStatusWriter:
    """
    ETF status data writer.

    Provides write access to ETF status data with year partitioning.
