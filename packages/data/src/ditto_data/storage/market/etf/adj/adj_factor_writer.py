...
Provides write access to ETF adjustment factors for dividend/split/bonus events
...
class EtfAdjFactorWriter:
    """
    ETF adjustment factor data writer.

    Provides write access to ETF adjustment factors with year partitioning.
