...
from ditto_data.storage.schemas.market_schemas import (
...
from ditto_data.storage.schemas.metadata_schemas import (
    INDEX_WEIGHT_STORE_SCHEMA,
    UNIVERSE_CONSTITUENT_STORE_SCHEMA,
)
from ditto_data.storage.schemas.store_schema import StoreSchema
