...
"""ETF daily bars writer.

Provides write access to ETF OHLCV daily bar data stored in Parquet files
...
class EtfBarsWriter:
    """
    ETF daily bars data writer.

    Provides write access to ETF daily bars data with year partitioning.
