...
Provides write access to index daily bars data stored in Parquet files
...
class IndexBarsWriter:
    """
    Index daily bars data writer.

    Provides write access to index daily bars data with year partitioning.
