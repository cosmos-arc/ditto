...
Provides read-only access to index daily bars data stored in Parquet files
...
class IndexBarsReader:
    """
    Index daily bars data reader.

    Provides read-only access to index daily bars data with year partitioning.
    ...
    Attributes:
        DATASET: Dataset name for index bars.

    """

    DATASET: str = "market/index/bars"

    def __init__(self, data_root: Path) -> None:
        """
        Initialize IndexBarsReader.
