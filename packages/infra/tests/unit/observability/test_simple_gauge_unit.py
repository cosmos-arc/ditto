...
import pytest
from ditto_infra.foundation import ObservabilityConfig, reset_for_testing
from ditto_infra.foundation.config.environment import Environment
from ditto_infra.foundation.observability.metrics import SimpleGauge, configure_metrics
